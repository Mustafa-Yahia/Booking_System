        ...
        <label for="name">Name on Card</label>
            ...
            <div class="form-group">
                <div>
                    ...
                    <p class="error" id="exErr"></p>

                </div>
                <div>
                    <label for="cvv">CVV</label>
                    <input type="password" name="cvv" id="cvv" maxlength="3" placeholder="123" required>
                     <p class="error" id="cvvErr"></p>

                </div>
            </div>

            <label for="cardNumber">Card Number</label>
            <input type="tel" name="cardNumber" id="cardNumber" maxlength="19" placeholder="1111 2222 3333 4444" required>
            <p class="error" id="cardErr"></p>
